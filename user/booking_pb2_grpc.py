...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetJson = channel.unary_unary(
                '/Booking/GetJson',
                request_serializer=booking__pb2.Empty4.SerializeToString,
                response_deserializer=booking__pb2.JsonBooking.FromString,
                )
        ...
        self.AddBookingForUser = channel.unary_unary(
                ...
                request_serializer=booking__pb2.SingleBook.SerializeToString,
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetJson': grpc.unary_unary_rpc_method_handler(
                    servicer.GetJson,
                    request_deserializer=booking__pb2.Empty4.FromString,
                    response_serializer=booking__pb2.JsonBooking.SerializeToString,
            ),
            ...
            'AddBookingForUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=booking__pb2.SingleBook.FromString,
...
class Booking(object):
    ...
    def GetJson(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Booking/GetJson',
            booking__pb2.Empty4.SerializeToString,
            booking__pb2.JsonBooking.FromString,
    ...
    def AddBookingForUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Booking/AddBookingForUser',
            booking__pb2.SingleBook.SerializeToString,
